    ...
    function r(u, l, h) {
        ...
        h.fn[u] = function(t) {
            ...
            (t = this).each(function(t, e) {
                var i = h.data(e, u);
                i ? (e = i[n]) && "_" != n.charAt(0) ? (i = e.apply(i, r),
                s = void 0 === s ? i : s) : c(o + " is not a valid method") : c(u + " not initialized. Cannot call methods, i.e. " + o)
            }),
            void 0 !== s ? s : t
        }
        ,
...
function(t, e) {
    ...
    function y(t) {
        ...
        (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
            ...
            n = f(e.height);
            return !1 !== n && (i.height = n + (t ? 0 : u + d)),
            i.innerWidth = i.width - (a + c),
            i.innerHeight = i.height - (u + d),
...
function(o, a) {
    ...
    }) : "object" == typeof module && module.exports ? module.exports = a(o, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate")) : (t = o.Flickity,
    ...
    p.updateSlides = function() {
        var n, r, s;
        this.slides = [],
        this.cells.length && (n = new a(this),
        this.slides.push(n),
        r = "left" == this.originSide ? "marginRight" : "marginLeft",
        s = this._getCanCellFit(),
        this.cells.forEach(function(t, e) {
            var i;
            n.cells.length && (i = n.outerWidth - n.firstMargin + (t.size.outerWidth - t.size[r]),
    ...
    p._containSlides = function() {
        ...
        this.slides.forEach(function(t) {
            n ? t.target = i * this.cellAlign : (t.target = Math.max(t.target, r),
    ...
    p.dispatchEvent = function(t, e, i) {
        ...
        this.emitEvent(t, n),
        s && this.$element && (n = t += this.options.namespaceJQueryEvents ? ".flickity" : "",
        e && ((e = new s.Event(e)).type = t,
        n = e),
    ...
    p._wrapSelect = function(t) {
        ...
        !this.isDragSelect && r < n ? t += e : !this.isDragSelect && i < n && (t -= e),
    ...
    ,
    o.debounceMethod(f, "onresize", 150),
    p.resize = function() {
        var t;
...
function(e, i) {
    ...
    t._bindStartEvent = function(t, e) {
        var i = (e = void 0 === e || e) ? "addEventListener" : "removeEventListener"
          , e = "mousedown";
        n.PointerEvent ? e = "pointerdown" : "ontouchstart"in n && (e = "touchstart"),
        t[i](e, this)
    }
    ,
...
function(e, i) {
    ...
    i._bindHandles = function(t) {
        for (var e = (t = void 0 === t || t) ? "addEventListener" : "removeEventListener", i = t ? this._touchActionValue : "", n = 0; n < this.handles.length; n++) {
            ...
            r[e]("click", this),
            s.PointerEvent && (r.style.touchAction = i)
        }
    }
    ,
...
function(n, r) {
    ...
    n._createDrag = function() {
        ...
        r && !o && (i.addEventListener("touchmove", function() {}),
        o = !0)
    }
    ,
    ...
    n.dragMove = function(t, e, i) {
        ...
        n = this.dragStartPosition + i.x * r,
        !this.options.wrapAround && this.slides.length && (n = (n = (r = Math.max(-this.slides[0].target, this.dragStartPosition)) < n ? .5 * (n + r) : n) < (r = Math.min(-this.getLastSlide().target, this.dragStartPosition)) ? .5 * (n + r) : n),
        this.dragX = n,
    ...
    n.dragEnd = function(t, e) {
        ...
        this.options.freeScroll && !this.options.wrapAround ? (n = this.getRestingPosition(),
        this.isFreeScrolling = -n > this.slides[0].target && -n < this.getLastSlide().target) : this.options.freeScroll || i != this.selectedIndex || (i += this.dragEndBoostSelect()),
    ...
    n._getClosestResting = function(t, e, i) {
        ...
        ; s(e, r) && (r = e,
        null !== (e = this.getSlideDistance(-t, n += i))); )
            e = Math.abs(e);
        return {
            distance: r,
            index: n - i
...
function(t, n) {
    ...
    s.prototype.createSVG = function() {
        ...
        var e, i = document.createElementNS(r, "path"), e = "string" != typeof (e = this.parent.options.arrowShape) ? "M " + e.x0 + ",50 L " + e.x1 + "," + (e.y1 + 50) + " L " + e.x2 + "," + (e.y2 + 50) + " L " + e.x3 + ",50  L " + e.x2 + "," + (50 - e.y2) + " L " + e.x1 + "," + (50 - e.y1) + " Z" : e;
...
function(t, i) {
    ...
    return i.insert = function(t, e) {
        ...
        o && o.length && (s = this.cells.length,
        e = void 0 === e ? s : e,
        r = o,
        ...
        i = n,
        (t = e == s) ? this.slider.appendChild(i) : (r = this.cells[e].element,
        this.slider.insertBefore(i, r)),
        0 === e ? this.cells = o.concat(this.cells) : t ? this.cells = this.cells.concat(o) : (s = this.cells.splice(e, s - e),
        this.cells = this.cells.concat(o).concat(s)),
        this._sizeCells(o),
        this.cellChange(e, !0))
    }
    ,
    ...
    i.remove = function(t) {
        ...
        t && t.length && (i = this.cells.length - 1,
        t.forEach(function(t) {
            t.remove();
...
function(t, i) {
    ...
    ,
    n.prototype.handleEvent = r.handleEvent,
...
function(t, e) {
    ...
    t.navCompanionSelect = function(t) {
        ...
        n && (i = n[0],
        e = this.navCompanion.cells.indexOf(i),
        i = e + n.length - 1,
        n = Math.floor((n = this.navCompanion.cellAlign,
        (i - e) * n + e)),
        this.selectCell(n, !1, t),
        this.removeNavSelectedElements(),
        n >= this.cells.length || (i = this.cells.slice(e, 1 + i),
        this.navSelectedElements = i.map(function(t) {
            return t.element
        }),
...
function(e, i) {
    ...
    function l(t, e, i) {
        if (!(this instanceof l))
            return new l(t,e,i);
        var n, r = t;
        (r = "string" == typeof t ? document.querySelectorAll(t) : r) ? (this.elements = (n = r,
        Array.isArray(n) ? n : "object" == typeof n && "number" == typeof n.length ? u.call(n) : [n]),
        this.options = a({}, this.options),
        "function" == typeof e ? i = e : a(this.options, e),
        i && this.on("always", i),
        this.getImages(),
        s && (this.jqDeferred = new s.Deferred),
        setTimeout(this.check.bind(this))) : o.error("Bad element for imagesLoaded " + (r || t))
    }
...
function(t, e) {
    ...
    function O(t) {
        ...
        for (i = t.length; i--; )
            t[i] && (t[i]._gsap || (t[i]._gsap = new ze(t[i],e))) || t.splice(i, 1);
        return t
    }
    function L(t) {
    ...
    function N() {
        var t, e, i = de.length, n = de.slice(0);
        for (fe = {},
        t = de.length = 0; t < i; t++)
    ...
    function d(t, e) {
        for (var i in e)
            "__proto__" !== i && "constructor" !== i && "prototype" !== i && (t[i] = w(e[i]) ? d(t[i] || (t[i] = {}), e[i]) : e[i]);
        return t
    }
    function j(t, e) {
        var i, n = {};
    ...
    function v(t, e) {
        var i = t._dp;
        return i && i.smoothChildTiming && t._ts && (t._start = M(i._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)),
        C(t),
        i._dirty || D(i, t)),
        t
    }
    function y(t, e) {
        var i;
        if ((e._time || e._initted && !e._dur) && (i = m(t.rawTime(), e),
        (!e._dur || mt(0, e.totalDuration(), i) - e._tTime > Gt) && e.render(i, !0)),
    ...
    function W(t, e, i, n) {
        return e.parent && q(e),
        e._start = M((F(i) ? i : i || t !== xt ? gt(t, i, e) : t._time) + e._delay),
        e._end = M(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)),
        function(t, e, i, n, r) {
            void 0 === i && (i = "_first");
    ...
    function _(t, e, i, n) {
        return Re(t, e),
        !t._initted || !i && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && At !== Fe.frame && (de.push(t),
        t._lazy = [e, n])
    }
    function x(t, e, i, n) {
        var r = t._repeat
          , s = M(e) || 0
          , e = t._tTime / t._tDur;
        return e && !n && (t._time *= s / t._dur),
        t._dur = s,
        t._tDur = r ? r < 0 ? 1e10 : M(s * (r + 1) + t._rDelay * r) : s,
        e && !n ? v(t, t._tTime = t._tDur * e) : t.parent && C(t),
        i || D(t.parent, t),
        t
    }
    function E(t) {
    ...
    function X(t, e, i) {
        var n, r, s = F(e[1]), o = (s ? 2 : 1) + (t < 2 ? 0 : 1), a = e[o];
        if (s && (a.duration = e[1]),
        a.parent = i,
        t) {
            for (n = a,
    ...
    function Q(t) {
        ...
        C = D[1]),
        function(t, e, i) {
            var n, r, s, o, a, u, l, h, c = (i || f).length, d = m[c];
            if (!d) {
                ...
                for (d = m[c] = [],
                n = v ? Math.min(h, c) * _ - .5 : D % h,
                r = v ? c * C / h - .5 : D / h | 0,
                l = Vt,
                a = u = 0; a < c; a++)
                    s = a % h - n,
                    o = r - (a / h | 0),
                    d[a] = o = y ? Math.abs("y" === y ? o : s) : Zt(s * s + o * o),
                    u < o && (u = o),
                    o < l && (l = o);
                "random" === D && G(d),
                d.max = u - l,
                d.min = l,
                d.v = c = (parseFloat(f.amount) || parseFloat(f.each) * (c < h ? c - 1 : y ? "y" === y ? c / h : h : Math.max(h, c / h)) || 0) * ("edges" === D ? -1 : 1),
                d.b = c < 0 ? g - c : g,
                d.u = H(f.amount || f.each) || 0,
                p = p && c < 0 ? ke(p) : p
            }
            return c = (d[t] - d.min) / d.max || 0,
            M(d.b + (p ? p(c) : c) * d.v) + d.u
        }
    }
    function K(i) {
    ...
    function $(u, t) {
        var l, h, e = ie(u);
        return !e && w(u) && (l = e = u.radius || Vt,
        u.values ? (u = vt(u.values),
        (h = !F(u[0])) && (l *= l)) : u = K(u.increment)),
        Y(t, e ? c(u) ? function(t) {
            return h = u(t),
            Math.abs(h - t) <= l ? h : t
        }
        : function(t) {
            for (var e, i, n = parseFloat(h ? t.x : t), r = parseFloat(h ? t.y : 0), s = Vt, o = 0, a = u.length; a--; )
                (e = h ? (e = u[a].x - n) * e + (i = u[a].y - r) * i : Math.abs(u[a] - n)) < s && (s = e,
                o = a);
    ...
    function tt(t) {
        for (var e, i, n, r, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
            n = t.indexOf(")", e),
            r = "[" === t.charAt(e + 7),
            i = t.substr(e + 7, n - e - 7).match(r ? ue : ne),
            o += t.substr(s, e - s) + Z(r ? i : +i[0], r ? 0 : +i[1], +i[2] || 1e-5),
            s = n + 1;
        return o + t.substr(s, t.length - s)
    }
    function et(t, e, i) {
        var n, r, s, o = t.labels, a = Vt;
        for (n in o)
    ...
    function rt(t, e, i) {
        ...
        if (!h) {
            ...
            xe[t])
                ...
                if (9 === (t = t.length < 6 ? "#" + (n = t.charAt(1)) + n + (r = t.charAt(2)) + r + (s = t.charAt(3)) + s + (5 === t.length ? t.charAt(4) + t.charAt(4) : "") : t).length)
                    return [(h = parseInt(t.substr(1, 6), 16)) >> 16, h >> 8 & Ce, h & Ce, parseInt(t.substr(7), 16) / 255];
                ...
                e) {
                    ...
                    o = +h[0] % 360 / 360,
                    a = h[1] / 100,
                    n = 2 * (u = h[2] / 100) - (r = u <= .5 ? u * (a + 1) : u + a - u * a),
                    3 < h.length && (h[3] *= 1),
                    h[0] = nt(o + 1 / 3, n, r),
                    h[1] = nt(o, n, r),
                    h[2] = nt(o - 1 / 3, n, r);
            else
                h = t.match(ne) || xe.transparent;
            h = h.map(Number)
        }
        return e && !l && (n = h[0] / Ce,
        r = h[1] / Ce,
        s = h[2] / Ce,
        u = ((t = Math.max(n, r, s)) + (e = Math.min(n, r, s))) / 2,
        t === e ? o = a = 0 : (l = t - e,
        a = .5 < u ? l / (2 - t - e) : l / (t + e),
        o = t === n ? (r - s) / l + (r < s ? 6 : 0) : t === r ? (s - n) / l + 2 : (n - r) / l + 4,
        o *= 60),
        h[0] = ~~(o + .5),
        h[1] = ~~(100 * a + .5),
        h[2] = ~~(100 * u + .5)),
    ...
    function ot(t, e, i) {
        var n, r, s, o, a = "", u = (t + a).match(Ee), l = e ? "hsla(" : "rgba(", h = 0;
        if (!u)
            return t;
        ...
        (n = i.c).join(a) !== s.c.join(a)))
            for (o = (r = t.replace(Ee, "1").split(se)).length - 1; h < o; h++)
                a += r[h] + (~n.indexOf(h) ? u.shift() || l + "0,0,0,0)" : (s.length ? s : u.length ? u : i).shift());
        if (!r)
            for (o = (r = t.split(Ee)).length - 1; h < o; h++)
                a += r[h] + u[h];
        return a + r[o]
    }
    function at(t) {
    ...
    function ut(t, e) {
        for (var i, n = t._first; n; )
            n instanceof Ie ? ut(n, e) : !n.vars.yoyoEase || n._yoyo && n._repeat || n._yoyo === e || (n.timeline ? ut(n.timeline, e) : (i = n._ease,
            n._ease = n._yEase,
            n._yEase = i,
            n._yoyo = e)),
            n = n._next
    ...
    function lt(t, e, i, n) {
        ...
        return f(t, function(t) {
            for (var e in Se[t] = he[t] = s,
            Se[r = t.toLowerCase()] = i,
            s)
                Se[r + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = Se[t + "." + e] = s[e]
        }),
        1
    }
    function ht(e) {
    ...
    function gt(t, e, i) {
        var n, r, s, o = t.labels, a = t._recent || ye, u = t.duration() >= Vt ? a.endTime(!1) : t._dur;
        return k(e) && (isNaN(e) || e in o) ? (r = e.charAt(0),
        s = "%" === e.substr(-1),
        n = e.indexOf("="),
        "<" === r || ">" === r ? (0 <= n && (e = e.replace(/=/, "")),
        ("<" === r ? a._start : a.endTime(0 <= a._repeat)) + (parseFloat(e.substr(1)) || 0) * (s ? (n < 0 ? a : i).totalDuration() / 100 : 1)) : n < 0 ? (e in o || (o[e] = u),
        o[e]) : (r = parseFloat(e.charAt(n - 1) + e.substr(n + 1)),
        s && i && (r = r / 100 * (ie(i) ? i[0] : i).totalDuration()),
        1 < n ? gt(t, e.substr(0, n - 1), i) + r : u + r)) : null == e ? u : +e
    }
    function mt(t, e, i) {
        return i < t ? t : e < i ? e : i
    }
    function vt(t, e, i) {
        return !k(t) || i || !bt && we() ? ie(t) ? (n = i,
        void 0 === r && (r = []),
        t.forEach(function(t) {
    ...
    var Ct, xt, Et, bt, Ft, wt, St, At, Tt, kt, Pt, Mt, Bt, zt, Ot, Lt, It, Nt, Rt, jt, qt, Wt, Ut, Xt, Yt = {
        ...
        overwrite: !1,
        delay: 0
    }, Vt = 1e8, Gt = 1 / Vt, Qt = 2 * Math.PI, Kt = Qt / 4, $t = 0, Zt = Math.sqrt, Jt = Math.cos, te = Math.sin, ee = "function" == typeof ArrayBuffer && ArrayBuffer.isView || function() {}
    , ie = Array.isArray, ne = /(?:-?\.?\d|\.)+/gi, re = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, se = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, oe = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, ae = /[+-]=-?[.\d]+/, ue = /[^,'"\[\]\s]+/gi, le = /[\d.+\-=]+(?:e[-+]\d*)*/i, he = {}, ce = {}, de = [], fe = {}, pe = {}, De = {}, ge = 30, me = [], ve = "", ye = {
        _start: 0,
        endTime: T,
        totalDuration: T
    }, _e = [].slice, Ce = 255, xe = {
    ...
    Bt = {
        ...
        wake: function() {
            St && (!bt && e() && (Et = bt = window,
            Ft = Et.document || {},
            he.gsap = hi,
            (Et.gsapVersions || (Et.gsapVersions = [])).push(hi.version),
            n(wt || Et.GreenSockGlobals || !Et.gsap && Et || {}),
            Mt = Et.requestAnimationFrame),
            kt && Bt.sleep(),
            Pt = Mt || function(t) {
        ...
        sleep: function() {
            (Mt ? Et.cancelAnimationFrame : clearTimeout)(kt),
            Tt = 0,
            Pt = T
        },
        ...
        return !Tt && Fe.wake()
    }, Se = {}, Ae = /^[\d.\-M][\d.\-,\s]/, Te = /["']/g, ke = function(e) {
        return function(t) {
            return 1 - e(1 - t)
        }
    }, Pe = function(t, e) {
        return t && (c(t) ? t : Se[t] || (s = ((i = t) + "").split("("),
        (o = Se[s[0]]) && 1 < s.length && o.config ? o.config.apply(null, ~i.indexOf("{") ? [function(t) {
            for (var e, i, n, r = {}, s = t.substr(1, t.length - 3).split(":"), o = s[0], a = 1, u = s.length; a < u; a++)
                i = s[a],
                e = a !== u - 1 ? i.lastIndexOf(",") : i.length,
                n = i.substr(0, e),
                r[o] = isNaN(n) ? n.replace(Te, "").trim() : +n,
                o = i.substr(e + 1).trim();
            return r
        }(s[1])] : (r = (n = i).indexOf("(") + 1,
        t = n.indexOf(")"),
        s = n.indexOf("(", r),
        n.substring(r, ~s && s < t ? n.indexOf(")", t + 1) : t).split(",").map(u))) : Se._CE && Ae.test(i) ? Se._CE("", i) : o)) || e;
        var i, n, r, s, o
    };
    function Me(t) {
        var e, i, n, r = Lt() - jt, s = !0 === t;
        if (It < r && (Rt += r - Nt),
        (0 < (r = (i = (jt += r) - Rt) - Wt) || s) && (n = ++Bt.frame,
        zt = i - 1e3 * Bt.time,
        Bt.time = i /= 1e3,
        Wt += r + (qt <= r ? 4 : qt - r),
        e = 1),
    ...
    Se.SteppedEase = Se.steps = he.SteppedEase = {
        config: function(t, e) {
    ...
    jn.totalTime = function(t, e) {
        ...
        if (i && i.smoothChildTiming && this._ts) {
            for (v(this, t),
            !i._dp || i.parent || y(i, this); i && i.parent; )
        ...
        return (this._tTime !== t || !this._dur && !e || this._initted && Math.abs(this._zTime) === Gt || !t && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = t),
        a(this, t, e)),
        this
    }
    ,
    ...
    jn.timeScale = function(t) {
        if (!arguments.length)
            return this._rts === -Gt ? 0 : this._rts;
        if (this._rts === t)
            return this;
        ...
        function(t) {
            for (var e = t.parent; e && e.parent; )
                ...
                e.totalDuration(),
                e = e.parent
        }(this.totalTime(mt(-this._delay, this._tDur, e), !0)),
        C(this),
        this
    }
    ,
    jn.paused = function(t) {
        ...
        this._ts = this._rts,
        this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== Gt && (this._tTime -= Gt)))),
        this) : this._ps
    }
    ,
    jn.startTime = function(t) {
        if (arguments.length) {
            ...
            return !e || !e._sort && this.parent || W(e, this, t - this._delay),
            this
        }
        return this._start
    }
    ...
    jn.repeat = function(t) {
        ...
        E(this)) : -2 === this._repeat ? 1 / 0 : this._repeat
    }
    ,
    ...
    jn.reversed = function(t) {
        return arguments.length ? (!!t !== this.reversed() && this.timeScale(-this._rts || (t ? -Gt : 0)),
        this) : this._rts < 0
    }
    ,
    ...
    var Ie = function(n) {
        ...
        e.set = function(t, e, i) {
            return e.duration = 0,
            e.parent = this,
            B(e).repeatDelay || (e.repeat = 0),
            e.immediateRender = !!e.immediateRender,
            new Ye(t,e,gt(this, i),1),
            this
        }
        ,
        ...
        e.staggerTo = function(t, e, i, n, r, s, o) {
            ...
            i.parent = this,
            new Ye(t,i,gt(this, r)),
            this
        }
        ,
        e.staggerFrom = function(t, e, i, n, r, s, o) {
            return i.runBackwards = 1,
            B(i).immediateRender = z(i.immediateRender),
            this.staggerTo(t, e, i, n, r, s, o)
        }
        ,
        e.staggerFromTo = function(t, e, i, n, r, s, o, a) {
            return n.startAt = i,
            B(n).immediateRender = z(n.immediateRender),
            this.staggerTo(t, e, n, r, s, o, a)
        }
        ,
        e.render = function(t, e, i) {
            var n, r, s, o, a, u, l, h, c, d, f = this._time, p = this._dirty ? this.totalDuration() : this._tDur, D = this._dur, g = t <= 0 ? 0 : M(t), m = this._zTime < 0 != t < 0 && (this._initted || !D);
            if ((g = this !== xt && p < g && 0 <= t ? p : g) !== this._tTime || i || m) {
                if (f !== this._time && D && (g += this._time - f,
                t += this._time - f),
                n = g,
                h = this._start,
                a = !(l = this._ts),
                ...
                this._repeat) {
                    ...
                    v && 1 & s && (n = D - n,
                    d = 1),
                    s !== (c = !f && this._tTime && c !== s ? s : c) && !this._lock) {
                        var m = v && 1 & c
                          , v = m === (v && 1 & s)
                          , f = (m = s < c ? !m : m) ? 0 : D;
                        if (this._lock = 1,
                        this.render(f || (d ? 0 : M(s * o)), e, !D)._lock = 0,
                        this._tTime = g,
                        !e && this.parent && _t(this, "onRepeat"),
                ...
                this._zTime = t,
                f = 0),
                !f && n && !e && (_t(this, "onStart"),
                this._tTime !== g))
                    return this;
                if (f <= n && 0 <= t)
                    for (y = this._first; y; ) {
                        if (r = y._next,
                        (y._act || n >= y._start) && y._ts && u !== y) {
                            if (y.parent !== this)
                                return this.render(t, e, i);
                            if (y.render(0 < y._ts ? (n - y._start) * y._ts : (y._dirty ? y.totalDuration() : y._tDur) + (n - y._start) * y._ts, e, i),
                    ...
                    for (var y = this._last, _ = t < 0 ? t : n; y; ) {
                        if (r = y._prev,
                        (y._act || _ <= y._end) && y._ts && u !== y) {
                            if (y.parent !== this)
                                return this.render(t, e, i);
                            if (y.render(0 < y._ts ? (_ - y._start) * y._ts : (y._dirty ? y.totalDuration() : y._tDur) + (_ - y._start) * y._ts, e, i),
                            n !== this._time || !this._ts && !a) {
                                u = 0,
                                r && (g += this._zTime = _ ? -Gt : Gt);
                                break
                            }
                        }
                        y = r
                ...
                if (u && !e && (this.pause(),
                u.render(f <= n ? 0 : -Gt)._zTime = f <= n ? 1 : -1,
                this._ts))
                    return this._start = h,
                    C(this),
                    this.render(t, e, i);
                this._onUpdate && !e && _t(this, "onUpdate", !0),
                (g === p && p >= this.totalDuration() || !g && f) && (h !== this._start && Math.abs(l) === Math.abs(this._ts) || this._lock || (!t && D || !(g === p && 0 < this._ts || !g && this._ts < 0) || q(this, 1),
                e || t < 0 && !f || !g && !f && p || (_t(this, g === p && 0 <= t ? "onComplete" : "onReverseComplete", !0),
        ...
        e.getChildren = function(t, e, i, n) {
            ...
            for (var r = [], s = this._first; s; )
                s._start >= n && (s instanceof Ye ? e && r.push(s) : (i && r.push(s),
        ...
        ,
        e.remove = function(t) {
            return k(t) ? this.removeLabel(t) : c(t) ? this.killTweensOf(t) : (p(this, t),
        ...
        e.totalTime = function(t, e) {
            ...
            !this._dp && this._ts && (this._start = M(Fe.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
        ...
        e.getTweensOf = function(t, e) {
            for (var i, n = [], r = vt(t), s = this._first, o = F(e); s; )
                s instanceof Ye ? function(t, e) {
                    for (var i = e.length, n = 0; t.indexOf(e[n]) < 0 && ++n < i; )
                        ;
                    return n < i
                }(s._targets, r) && (o ? (!qe || s._initted && s._ts) && s.globalTime(0) <= e && s.globalTime(s.totalDuration()) > e : !e || s.isActive()) && n.push(s) : (i = s.getTweensOf(r, e)).length && n.push.apply(n, i),
                s = s._next;
            return n
        }
        ,
        e.tweenTo = function(t, e) {
            e = e || {};
            var i, n = this, r = gt(n, t), s = e.startAt, o = e.onStart, a = e.onStartParams, t = e.immediateRender, u = Ye.to(n, R({
                ease: e.ease || "none",
                lazy: !1,
                immediateRender: !1,
                time: r,
                ...
                onStart: function() {
                    var t;
                    n.pause(),
                    i || (t = e.duration || Math.abs((r - (s && "time"in s ? s.time : n._time)) / n.timeScale()),
                    u._dur !== t && x(u, t, 0, 1).render(u._time, !0, !0),
                    i = 1),
                    o && o.apply(u, a || [])
                }
            }, e));
        ...
        e.totalDuration = function(t) {
            var e, i, n, r = 0, s = this, o = s._last, a = Vt;
            if (arguments.length)
            ...
            if (s._dirty) {
                for (n = s.parent; o; )
                    ...
                    a < (i = o._start) && s._sort && o._ts && !s._lock ? (s._lock = 1,
                    W(s, o, i - o._delay, 1)._lock = 0) : a = i,
                    i < 0 && o._ts && (r -= i,
                    ...
                    o = e;
                x(s, s === xt && s._time > r ? s._time : r, 1, 1),
                s._dirty = 0
            }
            return s._tDur
        }
    ...
    function Ne(t, e, i, n, r, s) {
        ...
        if (pe[t] && !1 !== (o = new pe[t]).init(r, o.rawVars ? e[t] : function(t, e, i, n, r) {
            if (!w(t = c(t) ? je(t, r, e, i, n) : t) || t.style && t.nodeType || ie(t) || ee(t))
                return k(t) ? je(t, r, e, i, n) : t;
            var s, o = {};
            for (s in t)
                o[s] = je(t[s], r, e, i, n);
            return o
        }(e[t], n, r, s, i), i, n, s) && (i._pt = a = new si(i._pt,r,t,0,1,o.render,o,0,o.priority),
        i !== li))
    ...
    function Re(t, e) {
        var i, n, r, s, o, a, u, l, h, c, d, f, p, D = t.vars, g = D.ease, m = D.startAt, v = D.immediateRender, y = D.lazy, _ = D.onUpdate, C = D.onUpdateParams, x = D.callbackScope, E = D.runBackwards, b = D.yoyoEase, F = D.keyframes, w = D.autoRevert, S = t._dur, A = t._startAt, T = t._targets, k = t.parent, P = k && "nested" === k.data ? k.parent._targets : T, M = "auto" === t._overwrite && !Ct, B = t.timeline;
        if (t._ease = Pe(g = !(!B || F && g) ? "none" : g, Ht.ease),
        t._yEase = b ? ke(Pe(!0 === b ? g : b, Ht.ease)) : 0,
        b && t._yoyo && !t._repeat && (b = t._yEase,
        t._yEase = t._ease,
        t._ease = b),
        t._from = !B && !!D.runBackwards,
        !B) {
            if (f = (l = T[0] ? L(T[0]).harness : 0) && D[l.prop],
            i = j(D, ce),
            A && A.render(-1, !0).kill(),
            m)
                ...
                e < 0 && !v && !w && t._startAt.render(-1, !0),
                v) {
                    if (0 < e && !w && (t._startAt = 0),
                    S && e <= 0)
            ...
            y = S && z(y) || y && !S,
            n = 0; n < T.length; n++) {
                if (u = (o = T[n])._gsap || O(T)[n]._gsap,
                t._ptLookup[n] = c = {},
                fe[u.id] && de.length && N(),
                d = P === T ? n : P.indexOf(o),
                l && !1 !== (h = new l).init(o, f || i, t, d, P) && (t._pt = s = new si(t._pt,o,h.name,0,1,h.render,h,0,h.priority),
                ...
                !l || f)
                    for (r in i)
                        pe[r] && (h = Ne(r, i, t, d, o, P)) ? h.priority && (a = 1) : c[r] = s = We.call(t, o, r, "get", i[r], d, P, 0, D.stringFilter);
                t._op && t._op[n] && t.kill(o, t._op[n]),
                M && t._pt && (qe = t,
                xt.killTweensOf(o, c, t.globalTime(e)),
                p = !t.parent,
                qe = 0),
                t._pt && y && (fe[u.id] = 1)
            }
    ...
    var qe, We = function(t, e, i, n, r, s, o, a, u) {
        c(n) && (n = n(r || 0, t, s));
        var l, r = t[e], s = "get" !== i ? i : c(r) ? u ? t[e.indexOf("set") || !c(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](u) : t[e]() : r, i = c(r) ? u ? Ke : Qe : Ge;
        if (k(n) && ("=" === (n = ~n.indexOf("random(") ? tt(n) : n).charAt(1) && (!(l = parseFloat(s) + parseFloat(n.substr(2)) * ("-" === n.charAt(0) ? -1 : 1) + (H(s) || 0)) && 0 !== l || (n = l))),
        s !== n)
            return isNaN(s * n) || "" === n ? (r || e in t || P(e, n),
            function(t, e, i, n, r, s, o) {
                var a, u, l, h, c, d = new si(this._pt,t,e,0,1,Je,null,r), f = 0, p = 0;
                for (d.b = i,
                d.e = n,
                i += "",
                (r = ~(n += "").indexOf("random(")) && (n = tt(n)),
                s && (s(s = [i, n], t, e),
                i = s[0],
                n = s[1]),
                a = i.match(oe) || []; c = oe.exec(n); )
                    l = c[0],
                    h = n.substring(f, c.index),
                    u ? u = (u + 1) % 5 : "rgba(" === h.substr(-5) && (u = 1),
                    l !== a[p++] && (c = parseFloat(a[p - 1]) || 0,
                    d._pt = {
                        _next: d._pt,
                        p: h || 1 === p ? h : ",",
                        s: c,
                    ...
                    f = oe.lastIndex);
                return d.c = f < n.length ? n.substring(f, n.length) : "",
                d.fp = o,
                (ae.test(n) || r) && (d.e = 0),
                this._pt = d
            }
            .call(this, t, e, s, n, i, a || Yt.stringFilter, u)) : (l = new si(this._pt,t,e,+s || 0,n - (s || 0),"boolean" == typeof r ? Ze : $e,0,i),
            u && (l.fp = u),
            o && l.modifier(o, this, t),
            this._pt = l)
    }, Ue = ve + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Xe = (Ue + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), Ye = function(E) {
        function r(t, e, i, n) {
            var r;
            "number" == typeof e && (i.duration = e,
            e = i,
            i = null);
            var s, o, a, u, l, h, c, d, f = (r = E.call(this, n ? e : B(e)) || this).vars, p = f.duration, D = f.delay, g = f.immediateRender, m = f.stagger, v = f.overwrite, y = f.keyframes, _ = f.defaults, n = f.scrollTrigger, C = f.yoyoEase, f = e.parent || xt, x = (ie(t) || ee(t) ? F(t[0]) : "length"in e) ? [t] : vt(t);
            if (r._targets = x.length ? O(x) : A("GSAP target " + t + " not found. https://greensock.com", !Yt.nullTargetWarn) || [],
            r._ptLookup = [],
            r._overwrite = v,
            y || m || S(p) || S(D)) {
                if (e = r.vars,
                ...
                y)
                    ...
                    w(m))
                        for (l in m)
                            ~Ue.indexOf(l) && ((d = d || {})[l] = m[l]);
                    for (o = 0; o < u; o++) {
                        for (l in a = {},
                        e)
                            Xe.indexOf(l) < 0 && (a[l] = e[l]);
                        a.stagger = 0,
                        C && (a.yoyoEase = C),
                        d && ft(a, d),
                        h = x[o],
                        a.duration = +je(p, b(r), o, h, x),
                        a.delay = (+je(D, b(r), o, h, x) || 0) - r._delay,
                        !m && 1 === u && a.delay && (r._delay = D = a.delay,
                        r._start += D,
                        a.delay = 0),
                        s.to(h, a, c(o, h, x))
                    }
                ...
                r.timeline = 0;
            return !0 !== v || Ct || (qe = b(r),
            xt.killTweensOf(x),
            qe = 0),
            W(f, b(r), i),
            e.reversed && r.reverse(),
            e.paused && r.paused(!0),
            (g || !p && !y && r._start === M(f._time) && z(g) && function t(e) {
                return !e || e._ts && t(e.parent)
            }(b(r)) && "nested" !== f.data) && (r._tTime = -Gt,
            r.render(Math.max(0, -D))),
            n && U(b(r), n),
            r
        }
        i(r, E);
        ...
        return t.render = function(t, e, i) {
            var n, r, s, o, a, u, l, h, c, d = this._time, f = this._tDur, p = this._dur, D = f - Gt < t && 0 <= t ? f : t < Gt ? 0 : t;
            if (p) {
                if (D !== this._tTime || !t || i || !this._initted && this._tTime || this._startAt && this._zTime < 0 != t < 0) {
                    ...
                    this._repeat) {
                        ...
                        n === d && !i && this._initted)
                            return this;
                        s !== a && (h && this._yEase && ut(h, u),
                        !this.vars.repeatRefresh || u || this._lock || (this._lock = i = 1,
                        this.render(M(o * s), !0).invalidate()._lock = 0))
                    }
                    if (!this._initted) {
                        if (_(this, t < 0 ? t : n, i, e))
                    ...
                    this._lazy = 0),
                    this.ratio = l = (c || this._ease)(n / p),
                    this._from && (this.ratio = l = 1 - l),
                    n && !d && !e && (_t(this, "onStart"),
                    this._tTime !== D))
                        return this;
                    for (r = this._pt; r; )
                        r.r(l, r.d),
                        r = r._next;
                    h && h.render(t < 0 ? t : !n && u ? -Gt : h._dur * l, e, i) || this._startAt && (this._zTime = t),
                    this._onUpdate && !e && (t < 0 && this._startAt && this._startAt.render(t, !0, i),
                    _t(this, "onUpdate")),
                    this._repeat && s !== a && this.vars.onRepeat && !e && this.parent && _t(this, "onRepeat"),
                    D !== this._tDur && D || this._tTime !== D || (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, !0),
                    !t && p || !(D === this._tDur && 0 < this._ts || !D && this._ts < 0) || q(this, 1),
                    e || t < 0 && !d || !D && !d || (_t(this, D === f ? "onComplete" : "onReverseComplete", !0),
                    !this._prom || D < f && 0 < this.timeScale() || this._prom()))
                }
            } else
                !function(t, e, i, n) {
                    var r, s, o, a = t.ratio, u = e < 0 || !e && (!t._start && function t(e) {
                        e = e.parent;
                        return e && e._ts && e._initted && !e._lock && (e.rawTime() < 0 || t(e))
                    }(t) && (t._initted || !Dt(t)) || (t._ts < 0 || t._dp._ts < 0) && !Dt(t)) ? 0 : 1, l = t._rDelay, h = 0;
                    if (l && t._repeat && (h = mt(0, t._tDur, e),
                    s = pt(h, l),
                    o = pt(t._tTime, l),
                    t._yoyo && 1 & s && (u = 1 - u),
                    s !== o && (a = 1 - u,
                    t.vars.repeatRefresh && t._initted && t.invalidate())),
                    u !== a || n || t._zTime === Gt || !e && t._zTime) {
                        if (t._initted || !_(t, e, n, i)) {
                            ...
                            t._onUpdate && !i && _t(t, "onUpdate"),
                            h && t._repeat && !i && t.parent && _t(t, "onRepeat"),
                            (e >= t._tDur || e < 0) && t.ratio === u && (u && q(t, 1),
                            i || (_t(t, u ? "onComplete" : "onReverseComplete", !0),
                            t._prom && t._prom()))
                        }
                    } else
                        t._zTime || (t._zTime = e)
        ...
        t.kill = function(t, e) {
            ...
            if (this.timeline) {
                ...
                return this.timeline.killTweensOf(t, e, qe && !0 !== qe.vars.overwrite)._first || it(this),
                this.parent && i !== this.timeline.totalDuration() && x(this, this._dur * this.timeline._tDur / i, 0, 1),
                this
            }
            var n, r, s, o, a, u, l, h = this._targets, c = t ? vt(t) : h, d = this._ptLookup, t = this._pt;
            ...
            e = a),
            e = function(t, e) {
                var i, n, r, s, t = t[0] ? L(t[0]).harness : 0, o = t && t.aliases;
                if (!o)
                    return e;
                for (n in i = ft({}, e),
                o)
            ...
            l = h.length; l--; )
                if (~c.indexOf(h[l]))
                    ...
                    o = e),
                    o)
                        (u = r && r[a]) && ("kill"in u.d && !0 !== u.d.kill(a) || p(this, u, "_pt"),
                        delete r[a]),
                        "all" !== s && (s[a] = 1);
            return this._initted && !this._pt && t && it(this),
            this
        }
        ,
        r.to = function(t, e, i) {
    ...
    f("staggerTo,staggerFrom,staggerFromTo", function(i) {
        Ye[i] = function() {
            ...
            return e.splice("staggerFromTo" === i ? 5 : 4, 0, 0),
            t[i].apply(t, e)
        }
    });
    function Ge(t, e, i) {
    ...
    function ii(t) {
        for (var e, i, n = this._pt; n; )
            i = n._next,
            n.p === t && !n.op || n.op === t ? p(this, n, "_pt") : n.dep || (e = 1),
            n = i;
        return !e
    }
    var ni = function(t, e) {
    ...
    var ai = {
            ...
            e.forEach(function(t) {
                ...
                t !== n) {
                    if (pe[e])
                        return;
                    R(n, R(j(t, r), i)),
                    ft(n.prototype, ft(r, j(t, i))),
                    pe[n.prop = e] = n,
                    t.targetTest && (me.push(n),
                    ce[e] = 1),
                    e = ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin"
                }
                s(e, n),
                t.register && t.register(hi, n, si)
            })
        },
        timeline: function(t) {
            return new Ie(t)
        ...
        getProperty: function(n, t, e, i) {
            var r = L((n = k(n) ? vt(n)[0] : n) || {}).get
              , s = e ? l : u;
            return "native" === e && (e = ""),
            n && (t ? s((pe[t] && pe[t].get || r)(n, t, e, i)) : function(t, e, i) {
        ...
        exportRoot: function(t, e) {
            ...
            i = xt._first; i; )
                n = i._next,
                !e && !i._dur && i instanceof Ye && i.vars.onComplete === i._targets[0] || W(r, i, i._start - i._delay),
                i = n;
            return W(xt, r, 0),
            r
        },
            ...
            init: function(t, n, e) {
                e._onInit = function(t) {
                    ...
                    !function(t, e) {
                        ...
                        for (i in e)
                            for (n = s.length; n--; )
                                (r = (r = t._ptLookup[n][i]) && r.d) && (r._pt && (r = function(t, e) {
    ...
    function Fi() {
        "undefined" != typeof window && window.document && (Ui = (Wi = window.document).documentElement,
        Yi = Ei("div") || {
            style: {}
        },
        Ei("div"),
    ...
    function wi(t) {
        var e, i = Ei("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = this.parentNode, r = this.nextSibling, s = this.style.cssText;
        if (Ui.appendChild(i),
        i.appendChild(this),
    ...
    function ki(t, e) {
        ...
        t.removeProperty(e.replace(mn, "-$1").toLowerCase())) : t.removeAttribute(e))
    }
    ...
    function Mi(t, e, i, n) {
        var r, s = parseFloat(i) || 0, o = (i + "").trim().substr((s + "").length) || "px", a = Yi.style, u = vn.test(e), l = "svg" === t.tagName.toLowerCase(), h = (l ? "client" : "offset") + (u ? "Width" : "Height"), c = "px" === n, d = "%" === n;
        return n === o || !s || Fn[n] || Fn[o] ? s : ("px" === o || c || (s = Mi(t, e, i, "px")),
        i = t.getCTM && Ti(t),
        !d && "%" !== o || !fn[e] && !~e.indexOf("adius") ? (a[u ? "width" : "height"] = 100 + (c ? o : n),
        n = ~e.indexOf("adius") || "em" === n && t.appendChild && !l ? t : t.parentNode,
        (l = (n = !(n = i ? (t.ownerSVGElement || {}).parentNode : n) || n === Wi || !n.appendChild ? Wi.body : n)._gsap) && d && l.width && u && l.time === Fe.time ? I(s / l.width * 100) : (!d && "%" !== o || (a.position = bi(t, "position")),
        n === t && (a.position = "static"),
        n.appendChild(Yi),
        r = Yi[h],
        n.removeChild(Yi),
        a.position = "absolute",
        u && d && ((l = L(n)).time = Fe.time,
        l.width = n[h]),
        I(c ? r * s / 100 : r && s ? 100 / r * s : 0))) : (r = i ? t.getBBox()[u ? "width" : "height"] : t[h],
        I(d ? s / r * 100 : s / 100 * r)))
    }
    function Bi(t, e, i, n) {
        var r;
        ...
        fn[e] && "transform" !== e ? (r = kn(t, n),
        r = "transformOrigin" !== e ? r[e] : r.svg ? r.origin : Pn(bi(t, xn)) + " " + r.zOrigin + "px") : (r = t.style[e]) && "auto" !== r && !n && !~(r + "").indexOf("calc(") || (r = Sn[e] && Sn[e](t, e, i) || bi(t, e) || o(t, e) || ("opacity" === e ? 1 : 0)),
        i && !~(r + "").trim().indexOf(" ") ? Mi(t, e, r, i) + i : r
    }
    function zi(t, e, i, n) {
        var r;
        i && "none" !== i || ((s = (r = bn(e, t, 1)) && bi(t, r, 1)) && s !== i ? (e = r,
        i = s) : "borderColor" === e && (i = bi(t, "borderTopColor")));
        var s, o, a, u, l, h, c, d, f, p, D = new si(this._pt,t.style,e,0,1,Je), g = 0, m = 0;
        if (D.b = i,
        D.e = n,
        i += "",
        "auto" == (n += "") && (t.style[e] = n,
        ...
        (n.match(se) || []).length) {
            for (; h = se.exec(n); )
                d = h[0],
                c = n.substring(g, h.index),
                u ? u = (u + 1) % 5 : "rgba(" !== c.substr(-5) && "hsla(" !== c.substr(-5) || (u = 1),
                d !== (l = o[m++] || "") && (a = parseFloat(l) || 0,
                f = l.substr((a + "").length),
                (p = "=" === d.charAt(1) ? +(d.charAt(0) + "1") : 0) && (d = d.substr(2)),
                h = parseFloat(d),
                d = d.substr((h + "").length),
                g = se.lastIndex - d.length,
                d || (d = d || Yt.units[e] || f,
                g === n.length && (n += d,
                D.e += d)),
                f !== d && (a = Mi(t, e, l, d) || 0),
            ...
            D.r = "display" === e && "none" === n ? gi : Di;
        return ae.test(n) && (D.e = 0),
        this._pt = D
    }
    function Oi(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            var i, n, r, s = e.t, o = s.style, a = e.u, e = s._gsap;
            if ("all" === a || !0 === a)
                o.cssText = "",
                n = 1;
            else
    ...
    function Ni(t, e) {
        var i, n, r, s = t._gsap || L(t), o = t.style, a = Ii(t);
        return s.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (a = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(",") ? An : a : (a !== An || t.offsetParent || t === Ui || s.svg || (n = o.display,
        o.display = "block",
        (s = t.parentNode) && t.offsetParent || (r = 1,
        i = t.nextSibling,
        Ui.appendChild(t)),
        a = Ii(t),
        n ? o.display = n : ki(t, "display"),
        r && (i ? s.insertBefore(t, i) : s ? s.appendChild(t) : Ui.removeChild(t))),
        e && 6 < a.length ? [a[0], a[1], a[4], a[5], a[12], a[13]] : a)
    }
    function Ri(t, e, i, n, r, s) {
        var o, a, u = t._gsap, l = r || Ni(t, !0), h = u.xOrigin || 0, c = u.yOrigin || 0, d = u.xOffset || 0, f = u.yOffset || 0, p = l[0], D = l[1], g = l[2], m = l[3], v = l[4], y = l[5], _ = e.split(" "), C = parseFloat(_[0]) || 0, r = parseFloat(_[1]) || 0;
        i ? l !== An && (o = p * m - D * g) && (a = C * (-D / o) + r * (p / o) - (p * y - D * v) / o,
        C = C * (m / o) + r * (-g / o) + (g * y - m * v) / o,
        r = a) : (C = (a = Ai(t)).x + (~_[0].indexOf("%") ? C / 100 * a.width : C),
        r = a.y + (~(_[1] || _[0]).indexOf("%") ? r / 100 * a.height : r)),
        n || !1 !== n && u.smooth ? (u.xOffset = d + ((v = C - h) * p + (y = r - c) * g) - v,
        u.yOffset = f + (v * D + y * m) - y) : u.xOffset = u.yOffset = 0,
        u.xOrigin = C,
        u.yOrigin = r,
        u.smooth = !!n,
        u.origin = e,
        ...
        t.style[xn] = "0px 0px",
        s && (Pi(s, u, "xOrigin", h, C),
        Pi(s, u, "yOrigin", c, r),
        Pi(s, u, "xOffset", d, u.xOffset),
        Pi(s, u, "yOffset", f, u.yOffset)),
        t.setAttribute("data-svg-origin", C + " " + r)
    }
    function ji(t, e, i) {
        var n = H(e);
    ...
    Ye.version = Ie.version = hi.version = "3.8.0",
    St = 1,
    e() && we();
    var Wi, Ui, Xi, Yi, Hi, Vi, Gi = Se.Power0, Qi = Se.Power1, Ki = Se.Power2, $i = Se.Power3, Zi = Se.Power4, Ji = Se.Linear, tn = Se.Quad, en = Se.Cubic, nn = Se.Quart, rn = Se.Quint, sn = Se.Strong, on = Se.Elastic, an = Se.Back, un = Se.SteppedEase, ln = Se.Bounce, hn = Se.Sine, cn = Se.Expo, dn = Se.Circ, fn = {}, pn = 180 / Math.PI, Dn = Math.PI / 180, gn = Math.atan2, mn = /([A-Z])/g, vn = /(?:left|right|width|margin|padding|x)/i, yn = /[\s,\(]\S/, _n = {
        autoAlpha: "opacity,visibility",
        scale: "scaleX,scaleY",
        alpha: "opacity"
    }, Cn = "transform", xn = Cn + "Origin", En = "O,Moz,ms,Ms,Webkit".split(","), bn = function(t, e, i) {
        var n = (e || Yi).style
          , r = 5;
        if (t in n && !i)
            return t;
    ...
    }, An = [1, 0, 0, 1, 0, 0], Tn = {}, kn = function(t, e) {
        var i = t._gsap || new ze(t);
        if ("x"in i && !e && !i.uncache)
            return i;
        var n, r, s, o, a, u, l, h, c, d, f, p, D, g, m, v, y, _, C, x, E, b, F, w, S, A = t.style, T = i.scaleX < 0, k = "deg", P = bi(t, xn) || "0", M = n = r = o = a = u = l = h = 0, B = s = 1;
        return i.svg = !(!t.getCTM || !Ti(t)),
        c = Ni(t, i.svg),
        i.svg && (_ = (!i.uncache || "0px 0px" === P) && !e && t.getAttribute("data-svg-origin"),
        Ri(t, _ || P, !!_ || i.originIsAbsolute, !1 !== i.smooth, c)),
        b = i.xOrigin || 0,
        w = i.yOrigin || 0,
        c !== An && (p = c[0],
        D = c[1],
        ...
        M = v = c[4],
        n = y = c[5],
        6 === c.length ? (B = Math.sqrt(p * p + D * D),
        s = Math.sqrt(m * m + g * g),
        o = p || D ? gn(D, p) * pn : 0,
        (l = g || m ? gn(g, m) * pn + o : 0) && (s *= Math.abs(Math.cos(l * Dn))),
        i.svg && (M -= b - (b * p + w * g),
        n -= w - (b * D + w * m))) : (S = c[6],
        F = c[7],
        E = c[8],
        ...
        r = c[14],
        a = (c = gn(S, b)) * pn,
        c && (_ = v * (d = Math.cos(-c)) + E * (f = Math.sin(-c)),
        C = y * d + e * f,
        x = S * d + b * f,
        E = v * -f + E * d,
        e = y * -f + e * d,
        ...
        u = (c = gn(-g, b)) * pn,
        c && (d = Math.cos(-c),
        w = m * (f = Math.sin(-c)) + w * d,
        p = _ = p * d - E * f,
        D = C = D * d - e * f,
        g = x = g * d - b * f),
        o = (c = gn(D, p)) * pn,
        c && (_ = p * (d = Math.cos(c)) + D * (f = Math.sin(c)),
        C = v * d + y * f,
        D = D * d - p * f,
        y = y * d - v * f,
        p = _,
        v = C),
        a && 359.9 < Math.abs(a) + Math.abs(o) && (a = o = 0,
        u = 180 - u),
        B = I(Math.sqrt(p * p + D * D + g * g)),
        s = I(Math.sqrt(y * y + S * S)),
        c = gn(v, y),
        l = 2e-4 < Math.abs(c) ? c * pn : 0,
        h = w ? 1 / (w < 0 ? -w : w) : 0),
        i.svg && (_ = t.getAttribute("transform"),
        i.forceCSS = t.setAttribute("transform", "") || !Li(bi(t, Cn)),
        _ && t.setAttribute("transform", _))),
        90 < Math.abs(l) && Math.abs(l) < 270 && (T ? (B *= -1,
        l += o <= 0 ? 180 : -180,
        o += o <= 0 ? 180 : -180) : (s *= -1,
        l += l <= 0 ? 180 : -180)),
        i.x = M - ((i.xPercent = M && (i.xPercent || (Math.round(t.offsetWidth / 2) === Math.round(-M) ? -50 : 0))) ? t.offsetWidth * i.xPercent / 100 : 0) + "px",
        i.y = n - ((i.yPercent = n && (i.yPercent || (Math.round(t.offsetHeight / 2) === Math.round(-n) ? -50 : 0))) ? t.offsetHeight * i.yPercent / 100 : 0) + "px",
        i.z = r + "px",
        i.scaleX = I(B),
        i.scaleY = I(s),
        i.rotation = I(o) + k,
        ...
        (i.zOrigin = parseFloat(P.split(" ")[2]) || 0) && (A[xn] = Pn(P)),
        i.xOffset = i.yOffset = 0,
        i.force3D = Yt.force3D,
        i.renderTransform = i.svg ? In : Vi ? Ln : Mn,
        i.uncache = 0,
        i
    }, Pn = function(t) {
        ...
        e.force3D = 0,
        Ln(t, e)
    }, Bn = "0deg", zn = "0px", On = ") ", Ln = function(t, e) {
        var i = e || this
          , n = i.xPercent
          , r = i.yPercent
          , s = i.x
          ...
          , y = ""
          , e = "auto" === g && t && 1 !== t || !0 === g;
        !v || h === Bn && l === Bn || (i = parseFloat(l) * Dn,
        t = Math.sin(i),
        g = Math.cos(i),
        i = parseFloat(h) * Dn,
        s = ji(m, s, t * (t = Math.cos(i)) * -v),
        o = ji(m, o, -Math.sin(i) * -v),
        a = ji(m, a, g * t * -v + v)),
        D !== zn && (y += "perspective(" + D + On),
        (n || r) && (y += "translate(" + n + "%, " + r + "%) "),
        !e && s === zn && o === zn && a === zn || (y += a !== zn || e ? "translate3d(" + s + ", " + o + ", " + a + ") " : "translate(" + s + ", " + o + On),
        u !== Bn && (y += "rotate(" + u + On),
        l !== Bn && (y += "rotateY(" + l + On),
        h !== Bn && (y += "rotateX(" + h + On),
        c === Bn && d === Bn || (y += "skew(" + c + ", " + d + On),
        1 === f && 1 === p || (y += "scale(" + f + ", " + p + On),
        m.style[Cn] = y || "translate(0, 0)"
    }, In = function(t, e) {
        var i, n, r, s, o, a = e || this, u = a.xPercent, l = a.yPercent, h = a.x, c = a.y, d = a.rotation, f = a.skewX, p = a.skewY, D = a.scaleX, g = a.scaleY, m = a.target, v = a.xOrigin, y = a.yOrigin, _ = a.xOffset, C = a.yOffset, x = a.forceCSS, e = parseFloat(h), a = parseFloat(c), d = parseFloat(d), f = parseFloat(f);
        ...
        s = g,
        n = r = 0),
        (e && !~(h + "").indexOf("px") || a && !~(c + "").indexOf("px")) && (e = Mi(m, "x", h, "px"),
        a = Mi(m, "y", c, "px")),
        (v || y || _ || C) && (e = I(e + v - (v * i + y * r) + _),
        a = I(a + y - (v * n + y * s) + C)),
        (u || l) && (e = I(e + u / 100 * (o = m.getBBox()).width),
        a = I(a + l / 100 * o.height)),
        m.setAttribute("transform", o = "matrix(" + i + "," + n + "," + r + "," + s + "," + e + "," + a + ")"),
        x && (m.style[Cn] = o)
    };
    ...
    var Nn, Rn = {
        ...
        init: function(t, e, i, n, r) {
            var s, o, a, u, l, h, c, d, f, p, D, g, m, v, y, _, C, x, E, b, F, w, S = this._props, A = t.style, T = i.vars.startAt;
            for (l in Xi || Fi(),
            e)
                ...
                !pe[l] || !Ne(l, e, i, n, t, r)))
                    if (x = typeof o,
                    C = Sn[l],
                    "function" === x && (x = typeof (o = o.call(i, n, t, r))),
                    "string" === x && ~o.indexOf("random(") && (o = tt(o)),
                    C)
                        C(this, t, l, o, i) && (m = 1);
                        ...
                        Ee.test(s) || (h = H(s),
                        c = H(o)),
                        c ? h !== c && (s = Mi(t, l, s, c) + c) : h && (o += h),
                        this.add(A, "setProperty", s, o, n, r, 0, 0, l),
                        S.push(l);
                    else if ("undefined" !== x) {
                        if (T && l in T ? (s = "function" == typeof T[l] ? T[l].call(i, n, t, r) : T[l],
                        l in Yt.units && !H(s) && (s += Yt.units[l]),
                        "=" === ((s = k(s) && ~s.indexOf("random(") ? tt(s) : s) + "").charAt(1) && (s = Bi(t, l))) : s = Bi(t, l),
                        u = parseFloat(s),
                        (d = "string" === x && "=" === o.charAt(1) ? +(o.charAt(0) + "1") : 0) && (o = o.substr(2)),
                        a = parseFloat(o),
                        l in _n && ("autoAlpha" === l && Pi(this, A, "visibility", (u = 1 === u && "hidden" === Bi(t, "visibility") && a ? 0 : u) ? "inherit" : "hidden", a ? "inherit" : "hidden", !a),
                        "scale" !== l && "transform" !== l && ~(l = _n[l]).indexOf(",") && (l = l.split(",")[0])),
                        f = l in fn)
                            if (p || ((D = t._gsap).renderTransform && !e.parseTransform || kn(t, e.parseTransform),
                            g = !1 !== e.smoothOrigin && D.smooth,
                            (p = this._pt = new si(this._pt,A,Cn,0,1,D.renderTransform,D,0,-1)).dep = 1),
                            "scale" === l)
                                this._pt = new si(this._pt,D,"scaleY",D.scaleY,(d ? d * a : a - D.scaleY) || 0),
                                S.push("scaleY", l),
                                l += "X";
                            else {
                                if ("transformOrigin" === l) {
                                    ...
                                    F = b[0],
                                    w = b[1] || "50%",
                                    "top" !== F && "bottom" !== F && "left" !== w && "right" !== w || (E = F,
                                    F = w,
                                    w = E),
                                    b[0] = wn[F] || F,
                                    b[1] = wn[w] || w,
                                    o = b.join(" "),
                                    D.svg ? Ri(t, o, 0, g, 0, this) : ((c = parseFloat(o.split(" ")[2]) || 0) !== D.zOrigin && Pi(this, D, "zOrigin", D.zOrigin, c),
                                    Pi(this, A, l, Pn(s), Pn(o)));
                                    continue
                                }
                                if ("svgOrigin" === l) {
                                    Ri(t, o, 1, g, 0, this);
                                ...
                                if (l in Tn) {
                                    ...
                                    E = 360,
                                    F = k(b = o),
                                    w = parseFloat(b) * (F && ~b.indexOf("rad") ? pn : 1),
                                    w = C + (x = x ? w * x : w - C) + "deg",
                                    F && ("short" === (b = b.split("_")[1]) && (x %= E) != x % 180 && (x += x < 0 ? E : -E),
                                    "cw" === b && x < 0 ? x = (x + 36e9) % E - ~~(x / E) * E : "ccw" === b && 0 < x && (x = (x - 36e9) % E - ~~(x / E) * E)),
                                    v._pt = x = new si(v._pt,y,_,C,x,di),
                                    x.e = w,
                                    x.u = "deg",
                                    v._props.push(_);
                                    continue
                                ...
                                if ("transform" === l) {
                                    !function(t, e, i) {
                                        var n, r, s, o, a, u, l = qi({}, i._gsap), h = i.style;
                                        for (r in l.svg ? (s = i.getAttribute("transform"),
                                        i.setAttribute("transform", ""),
                                        h[Cn] = e,
                                        n = kn(i, 1),
                                        ki(i, Cn),
                                        i.setAttribute("transform", s)) : (s = getComputedStyle(i)[Cn],
                                        h[Cn] = e,
                                        n = kn(i, 1),
                                        h[Cn] = s),
                                        fn)
                                            (s = l[r]) !== (a = n[r]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(r) < 0 && (o = H(s) !== (u = H(a)) ? Mi(i, r, s, u) : parseFloat(s),
                                            a = parseFloat(a),
                                            t._pt = new si(t._pt,n,r,o,a - o,ci),
                                            t._pt.u = u || 0,
                                            t._props.push(r));
                                        qi(n, l)
                                    }(this, o, t);
                            ...
                            l in A || (l = bn(l) || l);
                        if (f || (a || 0 === a) && (u || 0 === u) && !yn.test(o) && l in A)
                            a = a || 0,
                            (h = (s + "").substr((u + "").length)) !== (c = H(o) || (l in Yt.units ? Yt.units[l] : h)) && (u = Mi(t, l, s, c)),
                            this._pt = new si(this._pt,f ? D : A,l,u,d ? d * a : a - u,f || "px" !== c && "zIndex" !== l || !1 === e.autoRound ? ci : pi),
                            this._pt.u = c || 0,
                            h !== c && "%" !== c && (this._pt.b = s,
                            this._pt.r = fi);
                        else if (l in A)
                            zi.call(this, t, l, s, o);
                        else {
                            if (!(l in t)) {
                                P(l, o);
                                continue
    ...
    hi.utils.checkPrefix = bn,
    Nn = f("x,y,z,scale,scaleX,scaleY,xPercent,yPercent" + "," + (qn = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function(t) {
        fn[t] = 1
    }),
    f(qn, function(t) {
        Yt.units[t] = "deg",
    ...
    _n[Nn[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + qn,
...
function(t, e) {
    ...
    function l(t, e, i, n, r, s, o) {
        var a, u, l, h, c, d, f, p, D, g, m, v, y = j(t), _ = H("paddingLeft", y), C = -999, x = H("borderBottomWidth", y) + H("borderTopWidth", y), E = H("borderLeftWidth", y) + H("borderRightWidth", y), b = H("paddingTop", y) + H("paddingBottom", y), F = H("paddingLeft", y) + H("paddingRight", y), w = .2 * H("fontSize", y), S = y.textAlign, A = [], T = [], k = [], P = e.wordDelimiter || " ", M = e.tag || (e.span ? "span" : "div"), y = e.type || e.split || "chars,words,lines", B = r && ~y.indexOf("lines") ? [] : null, z = ~y.indexOf("words"), O = ~y.indexOf("chars"), L = W(e), I = e.linesClass, N = ~(I || "").indexOf("++"), R = [];
        for (N && (I = I.split("++").join("")),
        ...
        if (B || L)
            for (a = 0; a < l; a++)
                ((d = (h = c[a]).parentNode === t) || L || O && !z) && (v = h.offsetTop,
                B && d && Math.abs(v - C) > w && ("BR" !== h.nodeName || 0 === a) && (B.push(f = []),
                C = v),
                L && (h._x = h.offsetLeft,
                h._y = v,
                h._w = h.offsetWidth,
                h._h = h.offsetHeight),
                B && ((h._isSplit && d || !O && d || z && d || !z && h.parentNode.parentNode === t && !h.parentNode._isSplit) && (f.push(h),
                h._x -= _,
                Y(h, t, P) && (h._wordEnd = !0)),
                "BR" === h.nodeName && (h.nextSibling && "BR" === h.nextSibling.nodeName || 0 === a) && B.push([])));
        for (a = 0; a < l; a++)
            d = (h = c[a]).parentNode === t,
            "BR" !== h.nodeName ? (L && (D = h.style,
            z || d || (h._x += h.parentNode._x,
            ...
            D.width = h._w + 1 + "px",
            D.height = h._h + "px"),
            !z && O ? h._isSplit ? (h._next = h.nextSibling,
            ...
            h.nextSibling && " " === h.nextSibling.textContent && !h.nextSibling.nextSibling && R.push(h.nextSibling),
            h._next = h.nextSibling && h.nextSibling._isFirst ? null : h.nextSibling,
            h.parentNode.removeChild(h),
            c.splice(a--, 1),
            l--) : d || (v = !h.nextSibling && Y(h.parentNode, t, P),
            h.parentNode._parent && h.parentNode._parent.appendChild(h),
            v && h.parentNode.appendChild(V.createTextNode(" ")),
            "span" === M && (h.style.display = "inline"),
            A.push(h)) : h.parentNode._isSplit && !h._isSplit && "" !== h.innerHTML ? T.push(h) : O && !h._isSplit && ("span" === M && (h.style.display = "inline"),
            A.push(h))) : B || L ? (h.parentNode && h.parentNode.removeChild(h),
            c.splice(a--, 1),
            l--) : z || t.appendChild(h);
        for (a = R.length; -1 < --a; )
            R[a].parentNode.removeChild(R[a]);
        if (B) {
            for (L && (g = V.createElement(M),
            t.appendChild(g),
            m = g.offsetWidth + "px",
            ...
            a = 0; a < B.length; a++) {
                for (f = B[a],
                (g = V.createElement(M)).style.cssText = "display:block;text-align:" + S + ";position:" + (L ? "absolute;" : "relative;"),
                I && (g.className = I + (N ? a + 1 : "")),
                k.push(g),
                l = f.length,
                u = 0; u < l; u++)
                    "BR" !== f[u].nodeName && (h = f[u],
                    g.appendChild(h),
                    p && h._wordEnd && g.appendChild(V.createTextNode(" ")),
                    L && (0 === u && (g.style.top = h._y + "px",
                    g.style.left = _ + v + "px"),
                    h.style.top = "0px",
                    v && (h.style.left = h._x - v + "px")));
                0 === l ? g.innerHTML = "&nbsp;" : z || O || (function t(e) {
                    for (var i, n = q(e.childNodes), r = n.length, s = 0; s < r; s++)
                        (i = n[s])._isSplit ? t(i) : (s && 3 === i.previousSibling.nodeType ? i.previousSibling.nodeValue += (3 === i.nodeType ? i : i.firstChild).nodeValue : 3 !== i.nodeType && e.insertBefore(i.firstChild, i),
                        e.removeChild(i))
                }(g),
                U(g, String.fromCharCode(160), " ")),
                L && (g.style.width = m,
        ...
        L && (o > t.clientHeight && (t.style.height = o - b + "px",
        t.clientHeight < o && (t.style.height = o + x + "px")),
        s > t.clientWidth && (t.style.width = s - F + "px",
    ...
    function h(t, e, i, n) {
        var r, s, o = q(t.childNodes), a = o.length, u = W(e);
        if (3 !== t.nodeType || 1 < a) {
            for (e.absolute = !1,
            r = 0; r < a; r++)
                3 === (s = o[r]).nodeType && !/\S+/.test(s.nodeValue) || (u && 3 !== s.nodeType && "inline" === j(s).display && (s.style.display = "inline-block",
        ...
        !function(t, e, i, n) {
            var r, s, o, a, u, l, h, c = e.tag || (e.span ? "span" : "div"), d = ~(e.type || e.split || "chars,words,lines").indexOf("chars"), f = W(e), p = e.wordDelimiter || " ", D = " " !== p ? "" : f ? "&#173; " : " ", g = "</" + c + ">", m = 1, v = e.specialChars ? "function" == typeof e.specialChars ? e.specialChars : C : null, y = V.createElement("div");
            for ((f = t.parentNode).insertBefore(y, t),
            ...
            !1 !== e.reduceWhiteSpace && (r = r.replace(E, " ").replace(x, "")),
            u = (r = y ? r.split("<").join("{{LT}}") : r).length,
            s = (" " === r.charAt(0) ? D : "") + i(),
            o = 0; o < u; o++)
                if (l = r.charAt(o),
                v && (h = v(r.substr(o), e.specialChars)))
                    l = r.substr(o, h || 1),
                    s += d && " " !== l ? n() + l + "</" + c + ">" : l,
                    o += h - 1;
                    ...
                    m = 0; r.charAt(o + 1) === p; )
                        s += D,
                        o++;
                    o === u - 1 ? s += D : ")" !== r.charAt(o + 1) && (s += D + i(),
                    m = 1)
                } else
                    "{" === l && "{{LT}}" === r.substr(o, 6) ? (s += d ? n() + "{{LT}}</" + c + ">" : "{{LT}}",
                    o += 5) : 55296 <= l.charCodeAt(0) && l.charCodeAt(0) <= 56319 || 65024 <= r.charCodeAt(o + 1) && r.charCodeAt(o + 1) <= 65039 ? (a = ((r.substr(o, 12).split(_) || [])[1] || "").length || 2,
                    s += d && " " !== l ? n() + r.substr(o, a) + "</" + c + ">" : r.substr(o, a),
                    o += a - 1) : s += d && " " !== l ? n() + l + "</" + c + ">" : l;
            t.outerHTML = s + (m ? g : ""),
            y && U(f, "{{LT}}", "<")
        }(t, e, i, n)
    }
    var V, i, n, x = /(?:\r|\n|\t\t)/g, E = /(?:\s\s+)/g, r = Array.isArray, s = [].slice, e = ((e = o.prototype).split = function(t) {
        this.isSplit && this.revert(),
        this.vars = t = t || this.vars,
        this._originals.length = this.chars.length = this.words.length = this.lines.length = 0;
        for (var e, i, n, r = this.elements.length, s = t.tag || (t.span ? "span" : "div"), o = u(t.wordsClass, s), a = u(t.charsClass, s); -1 < --r; )
            n = this.elements[r],
            this._originals[r] = n.innerHTML,
            e = n.clientHeight,
            i = n.clientWidth,
            h(n, t, o, a),
            l(n, t, this.chars, this.words, this.lines, i, e);
...
function(t, e) {
    ...
    function Bt(e, t) {
        var i = t.s
          ...
          , r = S.indexOf(e)
          , t = n === Re.sc ? 1 : 2;
        return ~r || (r = S.push(e) - 1),
        S[r + t] || (S[r + t] = Mt(e, i) || (Pt(e) ? n : function(t) {
    ...
    function zt(t) {
        return Mt(t, "getBoundingClientRect") || (Pt(t) ? function() {
            return Ye.width = ae.innerWidth,
            Ye.height = ae.innerHeight,
            Ye
        }
        : function() {
            return re(t)
    ...
    function Gt(t, e) {
        var i, n;
        return we(t) && (n = ~(i = t.indexOf("=")) ? (t.charAt(i - 1) + 1) * parseFloat(t.substr(i + 1)) : 0,
        ~i && (t.indexOf("%") > i && (n *= e / 100),
        t = t.substr(0, i - 1)),
        t = n + (t in z ? z[t] * e : ~t.indexOf("%") ? parseFloat(t) * e / 100 : parseFloat(t) || 0)),
        t
    }
    function Qt(t, e, i, n, r, s, o, a) {
        ...
        return d += "position:" + ((D || a) && p ? "fixed;" : "absolute;"),
        !D && !a && p || (d += (n === Re ? M : B) + ":" + (s + parseFloat(c)) + "px;"),
        o && (d += "box-sizing:border-box;text-align:left;width:" + o.offsetWidth + "px;"),
        f._isStart = i,
        f.setAttribute("class", "gsap-marker-" + t + (e ? " marker-" + e : "")),
        f.style.cssText = d,
        f.innerText = e || 0 === e ? t + "-" + e : t,
        r.children[0] ? r.insertBefore(f, r.children[0]) : r.appendChild(f),
    ...
    function h(t) {
        var e, i = oe.ticker.frame, n = [], r = 0;
        if (F !== i || Ce) {
            for (q(); r < I.length; r += 4)
                (e = ae.matchMedia(I[r]).matches) !== I[r + 3] && ((I[r + 3] = e) ? n.push(r) : q(1, I[r]) || Lt(I[r + 2]) && I[r + 2]());
            for (j(),
            r = 0; r < n.length; r++)
                e = n[r],
                _e = I[e],
    ...
    function Jt(t, e, i, n) {
        if (t.parentNode !== e) {
            for (var r, s = U.length, o = e.style, a = t.style; s--; )
                o[r = U[s]] = i[r];
            ...
            o[Ae] = Ut(t, Ne) + Ie,
            o[Te] = Ut(t, Re) + Ie,
            o[ze] = a[Oe] = a.top = a[P] = "0",
            se(n),
            a[Ae] = a.maxWidth = i[Ae],
            a[Te] = a.maxHeight = i[Te],
            a[ze] = i[ze],
    ...
    function te(t) {
        for (var e = X.length, i = t.style, n = [], r = 0; r < e; r++)
            n.push(X[r], i[X[r]]);
        return n.t = t,
        n
    }
    function ee(t, e, i, n, r, s, o, a, u, l, h, c, d) {
        Lt(t) && (t = t(a)),
        we(t) && "max" === t.substr(0, 3) && (t = c + ("=" === t.charAt(4) ? Gt("0" + t.substr(3), i) : 0));
        var f, p, D, g, m = d ? d.time() : 0;
        return d && d.seek(0),
        It(t) ? o && v(o, i, n, !0) : (Lt(e) && (e = e(a)),
        D = t.split(" "),
        p = kt(e) || he,
        (e = re(p) || {}) && (e.left || e.top) || "none" !== qt(p).display || (f = p.style.display,
        p.style.display = "block",
        e = re(p),
        f ? p.style.display = f : p.style.removeProperty("display")),
        f = Gt(D[0], e[n.d]),
        D = Gt(D[1] || "0", i),
        t = e[n.p] - u[n.p] - l + f + r - D,
        o && v(o, D, n, i - D < 20 || o._isStart && 20 < D),
        i -= i - D),
        s && (D = s._isStart,
        g = "scroll" + n.d2,
        v(s, i = t + i, n, D && 20 < i || !D && (h ? Math.max(he[g], le[g]) : s.parentNode[g]) <= i + 1),
        h && (u = re(o),
        h && (s.style[n.op.p] = u[n.op.p] - n.op.m - s._offset + Ie))),
        d && p && (g = re(p),
        d.seek(c),
        p = re(p),
        d._caScrollDist = g[n.p] - p[n.p],
    ...
    function ie(t, e, i, n) {
        if (t.parentNode !== e) {
            ...
            if (e === he) {
                ...
                s = qt(t))
                    +r || H.test(r) || !s[r] || "string" != typeof o[r] || "0" === r || (o[r] = s[r]);
                o.top = i,
                o.left = n
            } else
                o.cssText = t._stOrig;
            oe.core.getCache(t).uncache = 1,
            e.appendChild(t)
        }
    }
    function ne(a, t) {
        function u(t, e, i, n, r) {
            ...
            l = Math.round(i),
            e[d] = t,
            (e.modifiers = {})[d] = function(t) {
                return (t = f(c())) !== l && t !== h && 2 < Math.abs(t - l) ? (s.kill(),
                u.tween = 0) : t = i + n * s.ratio + r * s.ratio * s.ratio,
                h = l,
                l = f(t)
            }
            ,
        ...
        var l, h, c = Bt(a, t), d = "_scroll" + t.p2;
        return a[d] = c,
    ...
    function e() {
        if (!w) {
            ...
            if (Xe = n < W ? -1 : 1,
            W = n,
            i && (be && !De && 200 < e - be && (be = 0,
            N("scrollEnd")),
            fe = A,
            A = e),
            Xe < 0) {
                for (ge = t; 0 < ge--; )
                    We[ge] && We[ge].update(0, i);
                Xe = 1
            } else
                for (ge = 0; ge < t; ge++)
                    We[ge] && We[ge].update(0, i);
    ...
    function se(t) {
        if (t) {
            ...
            for ((t.t._gsap || oe.core.getCache(t.t)).uncache = 1; s < r; s += 2)
                i = t[s + 1],
                e = t[s],
                i ? n[e] = i : n[e] && n.removeProperty(e.replace(Y, "-$1").toLowerCase())
        }
    }
    var oe, d, ae, ue, le, he, p, D, g, m, ce, de, fe, y, pe, De, _, ge, C, x, E, me, ve, b, ye, _e, F, w, Ce = 1, xe = [], S = [], Ee = Date.now, A = Ee(), be = 0, Fe = 1, we = function(t) {
        return "string" == typeof t
    }, Se = Math.abs, T = "scrollLeft", k = "scrollTop", P = "left", M = "right", B = "bottom", Ae = "width", Te = "height", ke = "Right", Pe = "Left", Me = "Top", Be = "Bottom", ze = "padding", Oe = "margin", Le = "Width", Ie = "px", Ne = {
        s: T,
        p: P,
        p2: Pe,
        os: M,
        ...
        bottom: 1,
        right: 1
    }, We = [], Ue = {}, O = {}, L = [], I = [], N = function(t) {
        return O[t] && O[t].map(function(t) {
            return t()
        }) || L
    }, R = [], j = function(t) {
        for (var e = 0; e < R.length; e += 5)
            t && R[e + 4] !== t || (R[e].style.cssText = R[e + 1],
        ...
        e && j(e),
        e || N("revert")
    }, W = 0, Xe = 1, U = [P, "top", B, M, Oe + Be, Oe + ke, Oe + Me, Oe + Pe, "display", "flexShrink", "float", "zIndex", "grid-column-start", "grid-column-end", "grid-row-start", "grid-row-end", "grid-area", "justify-self", "align-self", "place-self"], X = U.concat([Ae, Te, "boxSizing", "max" + Le, "maxHeight", "position", Oe, ze, ze + Me, ze + ke, ze + Be, ze + Pe]), Y = /([A-Z])/g, Ye = {
        left: 0,
        top: 0
    ...
    var V = (He.prototype.init = function(m, v) {
        ...
        Fe ? (Y = (m = Wt(we(m) || It(m) || m.nodeType ? {
            trigger: m
        } : m, qe)).onUpdate,
        H = m.toggleClass,
        r = m.id,
        ...
        rt = m.pinReparent,
        i = m.pinSpacer,
        st = m.containerAnimation,
        ot = m.fastScrollEnd,
        at = m.preventOverlaps,
        ut = m.horizontal || m.containerAnimation && !1 !== m.horizontal ? Ne : Re,
        lt = !Q && 0 !== Q,
        ht = kt(m.scroller || ae),
        s = oe.core.getCache(ht),
        ct = Pt(ht),
        dt = "fixed" === ("pinType"in m ? m.pinType : Mt(ht, "pinType") || ct && "fixed"),
        ft = [m.onEnter, m.onLeave, m.onEnterBack, m.onLeaveBack],
        pt = lt && m.toggleActions.split(" "),
        h = ("markers"in m ? m : qe).markers,
        Dt = !ct && parseFloat(qt(ht)["border" + ut.p2 + Le]) || 0,
        gt = this,
        o = m.onRefreshInit && function() {
        ...
        St = ut.d2,
        At = ut.a,
        mt = (At = Mt(bt, "getBoundingClientRect")) ? function() {
            return At()[wt]
        }
        : function() {
        ...
        ,
        Et = ht,
        vt = !ct || ~xe.indexOf(Et) ? zt(Et) : function() {
            return Ye
        }
        ,
        yt = 0,
        ...
        tt *= 45,
        gt.scroller = ht,
        gt.scroll = st ? st.time.bind(st) : _t,
        y = _t(),
        gt.vars = m,
        v = v || m.animation,
        "refreshPriority"in m && (me = 1),
        s.tweenScroll = s.tweenScroll || {
            top: ne(ht, Re),
            left: ne(ht, Ne)
        },
        gt.tweenTo = d = s.tweenScroll[ut.p],
        v && (v.vars.lazy = !1,
        v._initted || !1 !== v.vars.immediateRender && !1 !== m.immediateRender && v.render(0, !0, !0),
        gt.animation = v.pause(),
        v.scrollTrigger = gt,
        (t = It(Q) && Q) && (N = oe.to(v, {
            ease: "power3",
            duration: t,
        ...
        c = Lt(nt.snapTo) ? nt.snapTo : "labels" === nt.snapTo ? (xt = v,
        function(t) {
            return oe.utils.snap(Xt(xt), t)
        }
        ) : "labelsDirectional" === nt.snapTo ? (Ct = v,
        function(t, e) {
        ...
        : oe.utils.snap(nt.snapTo),
        R = Nt(R = nt.duration || {
            min: .1,
            max: 2
        }) ? de(R.min, R.max) : de(R, R),
        j = oe.delayedCall(nt.delay || t / 2 || .1, function() {
            var t, e, i, n, r, s, o, a, u, l, h;
            Math.abs(gt.getVelocity()) < 10 && !De && yt !== _t() ? (e = ((t = v && !lt ? v.totalProgress() : gt.progress) - I) / (Ee() - fe) * 1e3 || 0,
            i = oe.utils.clamp(-gt.progress, 1 - gt.progress, Se(e / 2) * e / .185),
            n = gt.progress + (!1 === nt.inertia ? 0 : i),
            r = de(0, 1, c(n, gt)),
            s = _t(),
            o = Math.round(C + r * S),
            a = nt.onStart,
            ...
            l = nt.onComplete,
            h = d.tween,
            s <= x && C <= s && o !== s && (h && !h._initted && h.data <= Se(o - s) || (!1 === nt.inertia && (i = r - gt.progress),
            d(o, {
                ...
                onComplete: function() {
                    yt = _t(),
                    L = I = v && !lt ? v.totalProgress() : gt.progress,
                    et && et(gt),
                    l && l(gt)
                }
            }, s, i * S, o - s - i * S),
            a && a(gt, d.tween)))) : gt.isActive && j.restart(!0)
        }).pause()),
        r && (Ue[r] = gt),
        K = gt.trigger = kt(K || $),
        $ = !0 === $ ? K : kt($),
        ...
        $ && (!1 === Z || Z === Oe || (Z = !(!Z && "flex" === qt($.parentNode).display) && ze),
        gt.pin = $,
        !1 !== m.force3D && oe.set($, {
            force3D: !0
        }),
        (n = oe.core.getCache($)).spacer ? A = n.pinState : (i && ((i = kt(i)) && !i.nodeType && (i = i.current || i.nativeElement),
        n.spacerIsNative = !!i,
        i && (n.spacerState = te(i))),
        n.spacer = P = i || ue.createElement("div"),
        P.classList.add("pin-spacer"),
        r && P.classList.add("pin-spacer-" + r),
        n.pinState = A = te($)),
        gt.spacer = P = n.spacer,
        l = qt($),
        p = l[Z + ut.os2],
        M = oe.getProperty($),
        f = oe.quickSetter($, ut.a, Ie),
        Jt($, P, l),
        k = te($)),
        h && (l = Nt(h) ? Wt(h, je) : je,
        F = Qt("scroller-start", r, ht, ut, l, 0),
        w = Qt("scroller-end", r, ht, ut, l, 0, F),
        h = F["offset" + ut.op.d2],
        E = Qt("start", r, ht, ut, l, h, 0, st),
        b = Qt("end", r, ht, ut, l, h, 0, st),
        st && (X = oe.quickSetter([E, b], ut.a, Ie)),
        dt || xe.length && !0 === Mt(ht, "fixedMarkers") || (h = qt(l = ct ? he : ht).position,
        l.style.position = "absolute" === h || "fixed" === h ? h : "relative",
        oe.set([F, w], {
            force3D: !0
        }),
        D = oe.quickSetter(F, ut.a, Ie),
        g = oe.quickSetter(w, ut.a, Ie))),
        st && (a = st.vars.onUpdate,
        u = st.vars.onUpdateParams,
        ...
        gt.revert = function(t) {
            var e = !1 !== t || !gt.enabled
              , t = pe;
            e !== gt.isReverted && (e && (gt.scroll.rec || (gt.scroll.rec = _t()),
            W = Math.max(_t(), gt.scroll.rec || 0),
            q = gt.progress,
            U = v && v.progress()),
            E && [E, b, F, w].forEach(function(t) {
            ...
            $ && (e ? function(t, e, i) {
                se(i);
                i = t._gsap;
                i.spacerIsNative ? se(i.spacerState) : t.parentNode !== e || (i = e.parentNode) && (i.insertBefore(t, e),
                i.removeChild(e))
            }($, P, A) : rt && gt.isActive || Jt($, P, qt($), O)),
            gt.isReverted = e)
        }
        ,
        gt.refresh = function(t, e) {
            if (!pe && gt.enabled || e)
                if ($ && t && be)
                    ...
                    pe = 1,
                    N && N.pause(),
                    J && v && v.progress(0).invalidate(),
                    gt.isReverted || gt.revert();
                    for (var i, n, r, s, o, a, u = mt(), l = vt(), h = st ? st.duration() : Ot(ht, ut), c = 0, d = 0, f = m.end, e = m.endTrigger || K, p = m.start || (0 !== m.start && K ? $ ? "0 0" : "0 100%" : 0), D = m.pinnedContainer && kt(m.pinnedContainer), t = K && Math.max(0, We.indexOf(gt)) || 0, g = t; g--; )
                        (r = We[g]).end || r.refresh(0, 1) || (pe = 1),
                        !(s = r.pin) || s !== K && s !== $ || r.isReverted || ((a = a || []).unshift(r),
                        r.revert());
                    for (Lt(p) && (p = p(gt)),
                    C = ee(p, K, u, ut, _t(), E, F, gt, l, Dt, dt, h, st) || ($ ? -.001 : 0),
                    Lt(f) && (f = f(gt)),
                    we(f) && !f.indexOf("+=") && (~f.indexOf(" ") ? f = (we(p) ? p.split(" ")[0] : "") + f : (c = Gt(f.substr(2), u),
                    f = we(p) ? p : C + c,
                    e = K)),
                    x = Math.max(C, ee(f || (e ? "100% 0" : h), e, u, ut, _t() + c, b, w, gt, l, Dt, dt, h, st)) || -.001,
                    S = x - C || (C -= .01) && .001,
                    c = 0,
                    g = t; g--; )
                        (s = (r = We[g]).pin) && r.start - r._pinPush < C && !st && (i = r.end - r.start,
                        s !== K && s !== D || It(p) || (c += i),
                        s === $ && (d += i));
                    if (C += c,
                    x += c,
                    ...
                    $)
                        ...
                        l = ut === Re,
                        t = _t(),
                        B = parseFloat(M(ut.a)) + d,
                        !h && 1 < x && ((ct ? he : ht).style["overflow-" + ut.a] = "scroll"),
                        Jt($, P, i),
                        k = te($),
                        n = re($, !0),
                        h = dt && Bt(ht, l ? Ne : Re)(),
                        Z && ((O = [Z + ut.os2, S + d + Ie]).t = P,
                        (g = Z === ze ? Ut($, ut) + S + d : 0) && O.push(ut.d, g + Ie),
                        se(O),
                        dt && _t(W)),
                        dt && ((o = {
                            ...
                            position: "fixed"
                        })[Ae] = o.maxWidth = Math.ceil(n.width) + Ie,
                        o[Te] = o.maxHeight = Math.ceil(n.height) + Ie,
                        o[Oe] = o[Oe + Me] = o[Oe + ke] = o[Oe + Be] = o[Oe + Pe] = "0",
                        o[ze] = i[ze],
                        o[ze + Me] = i[ze + Me],
                        o[ze + ke] = i[ze + ke],
                        o[ze + Be] = i[ze + Be],
                        ...
                        z = M(ut.a) - B + S + d,
                        S !== z && T.splice(T.length - 2, 2),
                        v.render(0, !0, !0),
                        o || v.invalidate(),
                        ve(0)) : z = S;
                    else if (K && _t() && !st)
                        for (n = K.parentNode; n && n !== he; )
                    ...
                    gt.revert(!1),
                    pe = 0,
                    v && lt && v._initted && v.progress() !== U && v.progress(U, !0).render(v.time(), !0, !0),
                    q !== gt.progress && (v && !lt && v.totalProgress(q, !0),
                    gt.progress = q,
                    gt.update(0, 0, 1)),
                    $ && Z && (P._pinOffset = Math.round(gt.progress * z)),
                    G && G(gt)
                }
        }
        ,
        ...
        gt.endAnimation = function() {
            Rt(gt.callbackAnimation),
            v && (N ? N.progress(1) : v.paused() ? lt || Rt(v, gt.direction < 0, 1) : Rt(v, v.reversed()))
        }
        ,
        ...
        gt.update = function(t, e, i) {
            ...
            st && !i && !t || (u = gt.scroll(),
            c = (h = t ? 0 : (u - C) / S) < 0 ? 0 : 1 < h ? 1 : h || 0,
            l = gt.progress,
            e && (_ = y,
            y = st ? _t() : u,
            nt && (I = L,
            L = v && !lt ? v.totalProgress() : c)),
            (c = tt && !c && $ && !pe && !Ce && be && C < u + (u - _) / (Ee() - fe) * tt ? 1e-4 : c) !== l && gt.enabled && (i = (o = (n = gt.isActive = !!c && c < 1) != (!!l && l < 1)) || !!c != !!l,
            gt.direction = l < c ? 1 : -1,
            gt.progress = c,
            i && !pe && (r = c && !l ? 0 : 1 === c ? 1 : 1 === l ? 2 : 3,
            lt && (s = !o && "none" !== pt[r + 1] && pt[r + 1] || pt[r],
            a = v && ("complete" === s || "reset" === s || s in v))),
            at && o && (a || Q || !v) && (Lt(at) ? at(gt) : gt.getTrailing(at).forEach(function(t) {
                return t.endAnimation()
            })),
            lt || (!N || pe || Ce ? v && v.totalProgress(c, !!pe) : (N.vars.totalProgress = c,
            N.invalidate().restart())),
            $ && (t && Z && (P.style[Z + ut.os2] = p),
            dt ? i && (h = !t && l < c && u < x + 1 && u + 1 >= Ot(ht, ut),
            rt && (t || !n && !h ? ie($, P) : (e = re($, !0),
            l = u - C,
            ie($, he, e.top + (ut === Re ? l : 0) + Ie, e.left + (ut === Re ? 0 : l) + Ie))),
            se(n || h ? T : k),
            z !== S && c < 1 && n || f(B + (1 !== c || h ? 0 : z))) : f(B + z * c)),
            !nt || d.tween || pe || Ce || j.restart(!0),
            H && (o || it && c && (c < 1 || !ye)) && ce(H.targets).forEach(function(t) {
                return t.classList[n || it ? "add" : "remove"](H.className)
            }),
            !Y || lt || t || Y(gt),
            i && !pe ? (lt && (a && ("complete" === s ? v.pause().totalProgress(1) : "reset" === s ? v.restart(!0).pause() : "restart" === s ? v.restart(!0) : v[s]()),
            Y && Y(gt)),
            !o && ye || (V && o && jt(gt, V),
            ft[r] && jt(gt, ft[r]),
            it && (1 === c ? gt.kill(!1, 1) : ft[r] = 0),
            o || ft[r = 1 === c ? 1 : 3] && jt(gt, ft[r])),
            ot && !n && Math.abs(gt.getVelocity()) > (It(ot) ? ot : 2500) && (Rt(gt.callbackAnimation),
            N ? N.progress(1) : Rt(v, !c, 1))) : lt && Y && !pe && Y(gt)),
            g && (c = st ? u / st.duration() * (st._caScrollDist || 0) : u,
            D(c + (F._isFlipped ? 1 : 0)),
            g(c)),
            X && X(-u / st.duration() * (st._caScrollDist || 0)))
        }
        ,
        ...
        gt.disable = function(t, e) {
            if (gt.enabled && (!1 !== t && gt.revert(),
            gt.enabled = gt.isActive = !1,
            e || N && N.pause(),
            W = 0,
            n && (n.uncache = 1),
            o && Vt(He, "refreshInit", o),
            j && (j.pause(),
            d.tween && d.tween.kill() && (d.tween = 0)),
            !ct)) {
                for (var i = We.length; i--; )
                    if (We[i].scroller === ht && We[i] !== gt)
                        return;
                Vt(ht, "resize", $t),
                Vt(ht, "scroll", Kt)
            }
        ...
        ,
        gt.enable(!1, !1),
        v && v.add && !S ? oe.delayedCall(.01, function() {
    ...
    He.register = function(t) {
        var e, i;
        return !d && (oe = t || r(),
        n() && window.document && (ae = window,
        ue = document,
        le = ue.documentElement,
        he = ue.body),
        oe && (ce = oe.utils.toArray,
        de = oe.utils.clamp,
        ve = oe.core.suppressOverwrites || Tt,
        oe.core.globals("ScrollTrigger", He),
        he)) && (g = ae.requestAnimationFrame || function(t) {
        ...
        p = [ae, ue, le, he],
        Ht(ue, "scroll", Kt),
        i = (e = he.style).borderTopStyle,
        e.borderTopStyle = "solid",
        t = re(he),
        Re.m = Math.round(t.top + Re.sc()) || 0,
        Ne.m = Math.round(t.left + Ne.sc()) || 0,
        i ? e.borderTopStyle = i : e.removeProperty("border-top-style"),
        y = setInterval(l, 200),
        oe.delayedCall(.5, function() {
            return Ce = 0
        }),
        Ht(ue, "touchcancel", Tt),
        Ht(he, "touchstart", Tt),
        u(Ht, ue, "pointerdown,touchstart,mousedown", function() {
            return De = 1
        }),
        u(Ht, ue, "pointerup,touchend,mouseup", function() {
            return De = 0
        }),
        _ = oe.utils.checkPrefix("transform"),
        X.push(_),
        d = Ee(),
        D = oe.delayedCall(.2, c).pause(),
        E = [ue, "visibilitychange", function() {
            var t = ae.innerWidth
              , e = ae.innerHeight;
            ue.hidden ? (C = t,
            x = e) : C === t && x === e || $t()
    ...
    He.config = function(t) {
        ...
        e && clearInterval(y) || (y = e) && setInterval(l, e),
        "autoRefreshEvents"in t && (s(Vt),
        s(Ht, t.autoRefreshEvents || "none"),
        b = -1 === (t.autoRefreshEvents + "").indexOf("resize"))
    }
    ,
    He.scrollerProxy = function(t, e) {
        var i = kt(t)
          ...
          , t = Pt(i);
        ~n && S.splice(n, t ? 6 : 2),
        t ? xe.unshift(ae, e, he, e, le, e) : xe.unshift(i, e)
    }
    ,
    He.matchMedia = function(t) {
        ...
        for (i in t)
            n = I.indexOf(i),
            r = t[i],
            "all" === (_e = i) ? r() : (e = ae.matchMedia(i)) && (e.matches && (s = r()),
            ~n ? (I[n + 1] = a(I[n + 1], r),
            I[n + 2] = a(I[n + 2], s)) : (n = I.length,
            I.push(i, r, s),
            e.addListener ? e.addListener(h) : e.addEventListener("change", h)),
            I[n + 3] = e.matches),
            _e = 0;
        return I
    }
    ...
    He.clearMatchMedia = function(t) {
        t || (I.length = 0),
        0 <= (t = I.indexOf(t)) && I.splice(t, 4)
    }
    ,
    He.isInViewport = function(t, e, i) {
        t = (we(t) ? kt(t) : t).getBoundingClientRect(),
        e = t[i ? Ae : Te] * e || 0;
    ...
    He);
    function He(t, e) {
        d || He.register(oe) || console.warn("Please gsap.registerPlugin(ScrollTrigger)"),
        this.init(t, e)
    }
    V.version = "3.8.0",
    V.saveStyles = function(t) {
        return t ? ce(t).forEach(function(t) {
            ...
            R.push(t, t.style.cssText, t.getBBox && t.getAttribute("transform"), oe.core.getCache(t), _e))
        }) : R
    }
    ,
    ...
    V.batch = function(t, e) {
        var i, n = [], r = {}, s = e.interval || .016, o = e.batchMax || 1e9;
        for (i in e)
            r[i] = "on" === i.substr(0, 2) && Lt(e[i]) && "onRefreshInit" !== i ? function(t) {
                var e = []
                  , i = []
                ...
                return function(t) {
                    e.length || n.restart(!0),
                    e.push(t.trigger),
                    i.push(t),
                    o <= e.length && n.progress(1)
                }
            }(e[i]) : e[i];
        return Lt(o) && (o = o(),
        Ht(V, "refresh", function() {
            return o = e.batchMax()
        })),
...
function(t, e) {
    ...
    function d(t) {
        if (!(t = y(t)[0]))
            return 0;
        var e, i, n, r, s = t.tagName.toLowerCase(), o = t.style, a = 1, u = 1;
        g(t) && (u = t.getScreenCTM(),
        a = F(u.a * u.a + u.b * u.b),
        u = F(u.d * u.d + u.c * u.c));
        try {
            n = t.getBBox()
        ...
        "path" === s)
            ...
            a !== u && D("Warning: <path> length cannot be measured when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."),
            e *= (a + u) / 2,
            o.strokeDasharray = n;
        else if ("rect" === s)
            e = 2 * d * a + 2 * l * u;
            ...
            for (i = t.getAttribute("points").match(E) || [],
            "polygon" === s && i.push(i[0], i[1]),
            e = 0,
            r = 2; r < i.length; r += 2)
                e += p(i[r - 2], i[r - 1], i[r], i[r + 1], a, u) || 0;
        else
            "circle" !== s && "ellipse" !== s || (d = d / 2 * a,
            l = l / 2 * u,
            e = Math.PI * (3 * (d + l) - F((3 * d + l) * (d + 3 * l))));
        return e || 0
    }
    function m(t, e) {
        if (!(t = y(t)[0]))
        ...
        var i = _.getComputedStyle(t)
          ...
          , i = n.indexOf(",");
        return e < (n = (i = i < 0 ? n.indexOf(" ") : i) < 0 ? e : c(n.substr(0, i)) || 1e-5) && (n = e),
    ...
    function v() {
        ...
        x = n = i(),
        y = n.utils.toArray,
        C = -1 !== ((_.navigator || {}).userAgent || "").indexOf("Edge"))
    }
    var n, y, _, C, x, E = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, b = {
        rect: ["width", "height"],
        circle: ["r", "r"],
        ellipse: ["rx", "ry"],
        line: ["x2", "y2"]
        ...
        init: function(t, e) {
            ...
            r = e,
            o = (i = m(t, s = l))[0],
            a = (a = r.indexOf(" ")) < 0 ? (u = void 0 !== o ? o + "" : r,
            r) : (u = r.substr(0, a),
            r.substr(a + 1)),
            u = ~u.indexOf("%") ? c(u) / 100 * s : c(u),
            u = (a = ~a.indexOf("%") ? c(a) / 100 * s : c(a)) < u ? [a, u] : [u, a],
            this._length = h(l + 10),
            0 === i[0] && 0 === u[0] ? (a = Math.max(1e-5, u[1] - l),
            this._dash = h(l + a),
            this._offset = h(l - i[1] + a),
            this._offsetPT = this.add(this, "_offset", this._offset, h(l - u[1] + a))) : (this._dash = h(i[1] - i[0]) || 1e-6,
            this._offset = h(-i[0]),
            this._dashPT = this.add(this, "_dash", this._dash, h(u[1] - u[0]) || 1e-5),
            this._offsetPT = this.add(this, "_offset", this._offset, h(-u[0]))),
            C && (n = _.getComputedStyle(t)).strokeLinecap !== n.strokeLinejoin && (u = c(n.strokeMiterlimit),
            this.add(t.style, "strokeMiterlimit", u, u + .01)),
            this._live = g(t) || ~(e + "").indexOf("live"),
            this._props.push("drawSVG"),
            1
        },
        render: function(t, e) {
            var i, n, r, s = e._pt, o = e._style;
            if (s) {
                for (e._live && (i = d(e._target) + 11) !== e._length && (r = i / e._length,
                e._length = i,
                e._offsetPT.s *= r,
                e._offsetPT.c *= r,
                ...
                1 !== t && t ? o.strokeDasharray = n + "px," + i + "px" : (n - r < .001 && i - n <= 10 && (o.strokeDashoffset = r + 1),
                o.strokeDasharray = r < .001 && i - n <= 10 ? "none" : r === n ? "0px, 999999px" : n + "px," + i + "px")
            }
        },
        getLength: d,
        getPosition: m
    };
    i() && n.registerPlugin(r),
    t.DrawSVGPlugin = r,
    t.default = r,
    "undefined" == typeof window || window !== t ? Object.defineProperty(t, "__esModule", {
        value: !0
...
function(t, e) {
    ...
    var d, f, D, r, o, g, m, n = {
        ...
        init: function(t, e, i, n, r) {
            ...
            s.tween = i,
            e = function(t, e, i, n) {
                if ("object" != typeof (t = u(t) ? t(e, i, n) : t))
                ...
                var r, s = {};
                for (r in t)
                    s[r] = "onAutoKill" !== r && u(t[r]) ? t[r](e, i, n) : t[r];
                return s
            }(e, n, t, r),
            s.vars = e,
            ...
            null != e.x ? (s.add(s, "x", s.x, h(e.x, t, "x", s.x, e.offsetX || 0), n, r),
            s._props.push("scrollTo_x")) : s.skipX = 1,
            null != e.y ? (s.add(s, "y", s.y, h(e.y, t, "y", s.y, e.offsetY || 0), n, r),
            s._props.push("scrollTo_y")) : s.skipY = 1
        },
        render: function(t, e) {
            for (var i, n, r, s = e._pt, o = e.target, a = e.tween, u = e.autoKill, l = e.xPrev, h = e.yPrev, c = e.isWin, d = e.snap, f = e.snapInline; s; )
                s.r(t, s.d),
                s = s._next;
            i = c || !e.skipX ? e.getX() : l,
            r = (n = c || !e.skipY ? e.getY() : h) - h,
            h = i - l,
            l = m.autoKillThreshold,
            e.x < 0 && (e.x = 0),
            e.y < 0 && (e.y = 0),
            u && (!e.skipX && (l < h || h < -l) && i < p(o, "x") && (e.skipX = 1),
            !e.skipY && (l < r || r < -l) && n < p(o, "y") && (e.skipY = 1),
            e.skipX && e.skipY && (a.kill(),
            e.vars.onAutoKill && e.vars.onAutoKill.apply(a, e.vars.onAutoKillParams || []))),
            c ? D.scrollTo(e.skipX ? i : e.x, e.skipY ? n : e.y) : (e.skipY || (o.scrollTop = e.y),
            e.skipX || (o.scrollLeft = e.x)),
            !d || 1 !== t && 0 !== t || (n = o.scrollTop,
            i = o.scrollLeft,
            f ? o.style.scrollSnapType = f : o.style.removeProperty("scroll-snap-type"),
            o.scrollTop = n + 1,
            o.scrollLeft = i + 1,
            o.scrollTop = n,
            o.scrollLeft = i),
